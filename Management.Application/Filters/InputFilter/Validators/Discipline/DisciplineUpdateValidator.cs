...
public class DisciplineUpdateValidator : AbstractValidator<DisciplineUpdateResource>, IValidatorBase<DisciplineUpdateResource>
{
    public DisciplineUpdateValidator()
    {
